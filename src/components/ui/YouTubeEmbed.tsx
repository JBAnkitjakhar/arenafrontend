...
import { extractYouTubeVideoId, getYouTubeEmbedUrl, getYouTubeThumbnail } from '@/lib/youtube-utils';
...
export function YouTubeEmbed({
  ...
  const embedUrl = getYouTubeEmbedUrl(videoId, { autoplay: showPlayer ? 1 : 0 });
...
export function YouTubeThumbnail({ url, className, onClick }: {
  url: string;
  className?: string;
  onClick?: () => void;
}) {
